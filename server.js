...
const CLIENTS = [
  { name: 'Norwegian Refugee Council', short: 'NRC', logo: '/images/clients/nrc.png' },
  { name: 'Windle International Somalia', short: 'WIS', logo: '/images/clients/wis.jpeg' },
  { name: 'Islamic Relief Somalia', short: 'Islamic Relief', logo: '/images/clients/islamic_relief.png' },
  { name: 'ACTED', short: 'ACTED', logo: '/images/clients/acted.jpeg' },
  { name: 'Social-Life & Agricultural Development Organization', short: 'SADO', logo: '/images/clients/sado.jpeg' },
  { name: 'ALIGHT', short: 'ALIGHT', logo: '/images/clients/alight.jpeg' },
  { name: 'World Food Programme', short: 'WFP', logo: '/images/clients/wfp.png' },
  { name: 'Save the Children', short: 'SAVE', logo: '/images/clients/save.jpeg' },
