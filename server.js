...
const CLIENTS = [
  { name: 'Norwegian Refugee Council', short: 'NRC' },
  { name: 'Windle International Somalia', short: 'WIS' },
  { name: 'Islamic Relief Somalia', short: 'Islamic Relief' },
  { name: 'ACTED', short: 'ACTED' },
  { name: 'Social-Life & Agricultural Development Organization', short: 'SADO' },
  { name: 'ALIGHT', short: 'ALIGHT' },
  { name: 'World Food Programme', short: 'WFP' },
  { name: 'Save the Children', short: 'SAVE' },
  { name: 'CONTRASAD', short: 'CONTRASAD' },
  { name: 'ARD', short: 'ARD' },
];
